...
#  TODO dodać tabelę vo bazy danych reprezentującą użytkownika
...
# ctrl alt l - automatyczne układanie kodu, ctrl r - zamiana danego tekstu, ctrl / - komentarz zaznaczonych linii
# kolejność programowania: make it work, make it properly, make it fas